        ...
        for (d = 0; d < b; d++) {
          H ||
            (H = E(document.body, "transform")
              ? "transform"
              : "-webkit-transform"), (g.animatables[d].target.style[H] = c[
            d
          ].join(" "));
        }
      g.currentTime = a;
